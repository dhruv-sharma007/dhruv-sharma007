...
[![My Skills](https://skillicons.dev/icons?i=cpp,python,js,ts,go,html,css,astro,react,tailwind,nodejs,express,prisma,mysql,postgresql,mongodb,redis,npm,bun,git,github,aws,postman,linux,neovim,webstorm,pycharm,vscode)](https://skillicons.dev)
